...
COL_NUMERICAS = ['tenure_months', 'monthly_charge', 'avg_monthly_usage_gb', 'customer_age',
    'num_products', 'tickets_grouped', 'riesgo_contrato',
    'late_payments', 'anchor_score']
COL_BINARIAS = ['is_promo', 'has_streaming', 'has_security_pack', 'num_servicios', 'cliente_problematico']
...
def get_preprocessor():
    ...
    transformer_ordinal = Pipeline(steps=[
        ('ordinal', OrdinalEncoder(categories=ORDINAL_CATEGORIAS, handle_unknown='use_encoded_value', unknown_value=-1))
    ])
